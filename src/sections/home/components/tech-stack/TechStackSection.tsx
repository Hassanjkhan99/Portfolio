// 🚀 ENHANCED TECH STACK SECTION COMPONENT
// Josh W. Comeau inspired tech stack with Three.js background and advanced interactions

import React, { useState, useEffect, useRef } from 'react'
import { motion, AnimatePresence } from 'framer-motion'
import { SkillCard } from './SkillCard'
import { skills, skillFilters, type SkillFilter } from '../../data'
...
export const TechStackSection: React.FC = () => {
  ...
  return (
    <section id="tech-stack-section" className="relative overflow-hidden w-full">
